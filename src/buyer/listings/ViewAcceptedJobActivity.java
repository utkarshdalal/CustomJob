...
public class ViewAcceptedJobActivity extends Activity {
	
	TextView mTitle, mDescription, mBid, mBidder, mViewAcceptedJobAttachmentsTitle;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_view_accepted_job);
		mTitle = (TextView) findViewById(R.id.ViewAcceptedJobTitle);
		mDescription = (TextView) findViewById(R.id.ViewAcceptedJobDescription);
		mBid = (TextView) findViewById(R.id.ViewAcceptedJobWinningBid);
		mBidder = (TextView) findViewById(R.id.ViewAcceptedJobWinningBidder);
		mContactButton = (Button) findViewById(R.id.ViewAcceptedJobContactSellerButton);
		objectId = getIntent().getExtras().getString(seller.listings.SellerListingsAdapter.OBJECT_ID);
		mViewAcceptedJobAttachmentsTitle = (TextView) findViewById(R.id.ViewAcceptedJobAttachmentsTitle);
		...
		query.getInBackground(objectId, new GetCallback<ParseObject>() {
			public void done(ParseObject object, ParseException e) {
				...
				/* Attachment */
				mAttachmentLayout = (LinearLayout)findViewById(R.id.ViewAcceptedJobAttachmentsContainer);
				...
				attachmentQuery.findInBackground(new FindCallback<ParseObject>() {
					...
					public void done(List<ParseObject> attachments, ParseException e) {
						mViewAcceptedJobAttachmentsTitle.setText(attachments.size() + " Attachments:");
